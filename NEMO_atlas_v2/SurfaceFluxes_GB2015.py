...
def plot_bias_TurbFlux_vs_GB2015(dat,variable,climatology='ANM', region = 'Tropics', add_product_in_title=True,
...
def plot_climato_TurbFlux_GB2015(variable, dat, climatology='ANM', region='Tropics', 
    ...
    common_plot_specs.update(plot_params(variable,'full_field'))
    #
    # -- And update with the custom_plot_params
    common_plot_specs.update(custom_plot_params)
    #
    # -- Do the plot and return with safe_mode_cfile_plot
